...
#define BIOS_ADDR         (void*)(BIOS_ADDR_BASE+GBAVM_ADDR)
#define BIOS_SIZE         (32 * 1024)

#define WORKRAM_NAME      "/GBAWRAM"
#define WORKRAM_ADDR_BASE (0x09200000)
#define WORKRAM_ADDR      (void*)(WORKRAM_ADDR_BASE)
#define WORKRAM_SIZE      (256 * 1024 * 2)

#define INTRAM_NAME       "/GBAIRAM"
#define INTRAM_ADDR_BASE  (0x09300000)
#define INTRAM_ADDR       (void*)(INTRAM_ADDR_BASE)
#define INTRAM_SIZE       (32 * 1024 * 2)

#define IOMEM_ADDR_BASE   (0x09400000)
#define IOMEM_ADDR        (void*)(IOMEM_ADDR_BASE)
#define IOMEM_SIZE        (16 * 1024)

#define PALETTE_ADDR_BASE (0x09500000)
#define PALETTE_ADDR      (void*)(PALETTE_ADDR_BASE)
#define PALETTE_SIZE      0x00000400

#define PALCONV_ADDR_BASE (PALETTE_ADDR_BASE + 0x1000)
#define PALCONV_ADDR      (void*)(PALCONV_ADDR_BASE)
#define PALCONV_SIZE      0x00000400

#define VRAM_ADDR_BASE    (0x09600000)
#define VRAM_ADDR         (void*)(VRAM_ADDR_BASE)
#define VRAM_SIZE         (96 * 1024 * 2)

#define OAM_ADDR_BASE     (0x09700000)
#define OAM_ADDR          (void*)(OAM_ADDR_BASE)
#define OAM_SIZE          0x00000400

#define ROM_NAME          "/GBAROM"
#define ROM_ADDR_BASE     (0x18000000)
#define ROM_ADDR          (void*)(ROM_ADDR_BASE)
...
extern u8  *bios_rom;
#else
extern u16  palette_ram[PALETTE_SIZE];
extern u16  oam_ram[OAM_SIZE];
extern u16  palette_ram_converted[PALETTE_SIZE];
extern u16  io_registers[IOMEM_SIZE];
extern u8   ewram[WORKRAM_SIZE];
extern u8   iwram[INTRAM_SIZE];
extern u8   vram[VRAM_SIZE];
extern u8   bios_rom[BIOS_SIZE];
#endif
