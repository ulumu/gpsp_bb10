...
#elif defined(PND_BUILD) || defined(RPI_BUILD) || defined(BB10_BUILD)
...
void flip_screen()
{
  screen_pixels = (u16 *)fb_flip_screen();
}
...
#elif defined(WIZ_BUILD) || defined(PND_BUILD) || defined (RPI_BUILD) || defined(BB10_BUILD)
...
void debug_screen_printf(const char *format, ...)
{
  ...
  SLOG("printing debug string %s at %d %d\n", str_buffer,
